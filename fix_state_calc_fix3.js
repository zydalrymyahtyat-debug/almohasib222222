...
const regex = /<div className="flex justify-between items-center mb-6">\s*<h3 className="text-lg font-black text-slate-800">[\s\S]*?<\/button>\s*<\/div>/g;

let matches = code.match(regex);
if (matches) {
  code = code.replace(matches[0], `<div className="flex justify-between items-center mb-6">
...
console.log("Fixed StatementView tags");
